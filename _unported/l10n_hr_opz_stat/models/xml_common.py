...
def check_required(self, dict_object, check_list):
    for key in check_list:
        if not dict_object.get(key, False):
            raise except_orm(_('Data Error'), _('Missing or misconfigured data : %s' % key))
    return True
