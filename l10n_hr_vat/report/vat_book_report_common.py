...
class get_vat_book_report_common(object):         
    ...
    def get_lines(self, report_object, data, stupci, row_start_values_sql, invoice_sql=''):
        ...
        for stupac in stupci:
            i += 1
            stupciSql[stupac] = self.create_column_query(stupac, all_taxes, company_id)
    ...
    def create_column_query(self, stupac, all_taxes, company_id): 
