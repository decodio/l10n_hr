...
class knjiga_ira(report_sxw.rml_parse):
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(knjiga_ira, self).set_context(objects, data, new_ids, report_type=report_type)
              
    def __init__(self, cr, uid, name, context=None):
        super(knjiga_ira, self).__init__(cr, uid, name, context=context)
