...
class pdv_obrazac(orm.TransientModel):
    ...
    def export_vat(self, cr, uid, ids, context=None):
        ...
        ObrazacPDV.set("verzijaSheme", "8.0")
        ObrazacPDV.set("xmlns", "http://e-porezna.porezna-uprava.hr/sheme/zahtjevi/ObrazacPDV/v8-0")
        ...
        Uskladjenost.text = "ObrazacPDV-v8-0"
        ...
        Podatak810 = ET.SubElement(Tijelo, "Podatak810")
        Podatak810.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII1',1) or 0)
        Podatak811 = ET.SubElement(Tijelo, "Podatak811")
        Podatak811.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII11',1) or 0)
        Podatak812 = ET.SubElement(Tijelo, "Podatak812")
        Podatak812.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII12',1) or 0)
        Podatak813 = ET.SubElement(Tijelo, "Podatak813")
        Podatak813.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII13',1) or 0)
        Podatak814 = ET.SubElement(Tijelo, "Podatak814")
        Podatak814.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII14',1) or 0)
        Podatak815 = ET.SubElement(Tijelo, "Podatak815")
        Podatak815.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII15',1) or 0)
        Podatak820 = ET.SubElement(Tijelo, "Podatak820")
        Podatak820.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII20',1) or 0)
        Podatak830 = ET.SubElement(Tijelo, "Podatak830")
        Podatak830.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII30',1) or 0)
        Podatak831 = ET.SubElement(Tijelo, "Podatak831")
        Podatak831.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII31',1) or 0)
        Podatak832 = ET.SubElement(Tijelo, "Podatak832")
        Podatak832.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII32',1) or 0)
        Podatak833 = ET.SubElement(Tijelo, "Podatak833")
        Podatak833.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII33',1) or 0)
        Podatak840 = ET.SubElement(Tijelo, "Podatak840")
        Podatak840.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII40',1) or 0)
        Podatak850 = ET.SubElement(Tijelo, "Podatak850")
        Podatak850.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII50',1) or 0)
        Podatak860 = ET.SubElement(Tijelo, "Podatak860")
        Podatak860.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII60',1) or 0)
        Podatak870 = ET.SubElement(Tijelo, "Podatak870")
        Podatak870.text = "%.2f" % (self._get_value(cr, uid, datas,'VIII70',1) or 0)
