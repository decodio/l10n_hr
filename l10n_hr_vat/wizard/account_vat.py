...
class account_vat_declaration(osv.osv_memory):
    ...
    _columns = {
        'close_vat': fields.boolean('Close VAT', help='If this field is True, VAT will be closed for given period.'),
        'closing_date': fields.date('Closing Date', help='Posting date for posting of VAT Settlement.'),
        'property_vat_account_payable': fields.property(
            type='many2one',
         ...
         'property_vat_account_receivable': fields.property(
            type='many2one',
            relation='account.account',
        ...
        'property_vat_close_journal': fields.property(
            type='many2one', 
    ...
    def create_vat(self, cr, uid, ids, context=None):
        ...
        if datas['form']['close_vat'] == True:
            datas['form']['date_from'] = False
            datas['form']['date_to'] = False
            if datas['form']['property_vat_close_journal'] == False:
                raise osv.except_osv(_('Error !'), _('VAT closing journal is missing! Please enter one.')) 
            if datas['form']['property_vat_account_receivable'] == False:
                raise osv.except_osv(_('Error !'), _('VAT Account Receivable is missing! Please enter one.')) 
            if datas['form']['property_vat_account_payable'] == False:
        ...
        return {
            ...
            'report_name': 'account.vat.settlement',
            'datas': datas,
        }
